  ...
  <ion-page class="ion-bg" id="admin">
    <ion-grid>
      <ion-row>
        ...
        <ion-col>
          <ion-content class="col-content ion-padding" :scroll-y="false">
            <ion-button
              class="back-pos"
              fill="clear"
              color="light"
            ...
            <h1 class="ion-padding-bottom">Organisations</h1>
            <ion-item
              lines="full"
              href="/organisation/#"
              detail="true"
              ...
              class="ion-bg"
            >
              <ion-thumbnail class="ion-img" slot="start">
                <img
                  class="org-logo"
            ...
            >
              <ion-thumbnail class="ion-img" slot="start">
                <img class="org-logo" src="@/theme/img/apple.svg" alt="apple" />
              </ion-thumbnail>
